 ...
 *
 * 参数的设置与原来的ImageCache和ImageSDCardCache一致(可以删除代码中的一些默认的设置)
 * ImageCache IMAGE_CACHE = imgCacheManager。getImgCache();
		    ...
		    public ImageSDCardCacheManager(){
		        ...
		        IMAGE_SD_CACHE.setOnGetDataListener(new OnGetDataListener<String, String>(){
					...
					public CacheObject<String> onGetData(String key) {
		            	...
		            	//下面与 ImageSDCardCache.getDefaultOnGetImageListener()内的实现相同
